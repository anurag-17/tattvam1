...
useEffect(() => {
            async function Timelines(){
                const timelinedata = await fetch('https://tattvamkolkata.com/wp-tattvam/wp-json/wp/v2/pages/33');
            ...
            async function cosntructionss(){
                const constructiondata = await fetch('https://tattvamkolkata.com/wp-tattvam/wp-json/wp/v2/construction_status');
